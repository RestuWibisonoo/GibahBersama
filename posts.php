...
<body class="bg-white min-h-screen flex items-center justify-center">
    ...
    <div class="absolute inset-0 bg-white p-6 flex flex-col">
        ...
        <!-- Input untuk Title -->
        <input class="w-full bg-transparent border-b border-gray-300 focus:outline-none py-2 text-lg font-medium" 
            placeholder="Judul Diskusi" type="text" />

        <!-- Input untuk Deskripsi Singkat -->
        <input class="mt-4 w-full bg-transparent border-b border-gray-300 focus:outline-none py-2"
